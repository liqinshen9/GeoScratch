...
| [camera-view.md](camera-view.md)                               | The default viewing angle: why the camera looks down the (1,1,1) isometric diagonal, and what depends on it                                                                                   |
...
| [shadows.md](shadows.md)                                       | Which lights cast, which objects cast into them, and why primitives skip the headlight's shadow pass                                                                                          |
